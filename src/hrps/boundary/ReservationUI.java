...
public class ReservationUI {
     ...
     * @throws CancelCheckInReservationException if the a checked a reservation is canceled as we
     * do not allow a guest to cancel a reservation that has already cheked in.
     */
