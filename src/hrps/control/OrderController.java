...
public class OrderController {
    ...
    public double findOrderedRoomServiceTotalPriceByRoom(Room targetRoom) {
        List<OrderedRoomService> orders = new ArrayList<>();
        ...
        if (orders.isEmpty()) {
            ...
            double sum = 0;
            for (OrderedRoomService orderedRoomService : orders) {
                sum += orderedRoomService.getTotalPrice();
            }
            return sum;
        }
    }
